...
def get_channel_stats(youtube, channel_id):
    ...
    print(f"Response for {channel_id}: {response}")  # Debugging print
    if 'items' in response and response['items']:  # Check if 'items' exists
